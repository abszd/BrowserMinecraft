...
export class Block {
    ...
    static atlasSize = { width: 48, height: 336 }; // Adjust to your actual atlas size
    ...
    // Helper method to create sides object from atlas coordinates
    ...
    static initializeBlocks() {
        ...
        // Define atlas layout using simple coordinates
        const atlasLayout = {
            dirt: { x: 0, y: 5 },
            grass_top: { x: 0, y: 3 },
            stone: { x: 0, y: 0 },
        ...
        // Register blocks using atlas coordinates
        Block.register(
            new Block(0, "dirt", {
                displayName: "Dirt",
